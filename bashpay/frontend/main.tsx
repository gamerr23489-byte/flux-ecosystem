...
const key=(import.meta.env.VITE_CLERK_PUBLISHABLE_KEY as string|undefined)||'pk_test_Y3VyaW91cy1sYWR5YmlyZC05NTIxLmNsZXJrLmFjY291bnRzLmRldiQ';const root=document.getElementById('root');
